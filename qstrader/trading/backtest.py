...
class BacktestTradingSession(TradingSession):
    ...
    def __init__(
        ...
        burn_in_dt=None,
        data_handler=None,
        month_period_of_rebalance: int = 1,
        **kwargs,
    ):
        self.start_dt = start_dt
        self.end_dt = end_dt
        self.month_period_of_rebalance = month_period_of_rebalance
    ...
    def _create_rebalance_event_times(self):
        ...
        if self.rebalance == "buy_and_hold":
            ...
            rebalancer = EndOfMonthRebalance(
                self.start_dt, self.end_dt, month_period=self.month_period_of_rebalance
            )
        else:
            raise ValueError(
